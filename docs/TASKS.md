...
[ ] PRD “범위(MVP)”와 User Flow “입장/대기실” 노드를 참고해 진행자/참여자 화면을 구성한다.
[ ] Database Design의 ROOM/PARTICIPANT 구조로 임시 저장 모델을 만든다.
[ ] TRD의 권한 모델에 맞춰 진행자만 “방 생성/종료”가 가능하도록 제한한다.
[ ] Design System에 맞춰 QR 공유 화면과 대기실 화면을 제작한다.
[ ] 입장 실패 시 안내 문구/재시도 흐름을 넣는다(공정성 체감 손상 방지).
...
[ ] PRD “성공 지표”에 맞춘 간단 설문/피드백 UI를 추가한다.
[ ] “공정성 체감 가이드” 문구를 Design System 톤에 맞게 반영한다.
